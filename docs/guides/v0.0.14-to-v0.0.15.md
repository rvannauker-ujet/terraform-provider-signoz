---
page_title: "SigNoz Provider v0.0.14 to v0.0.15 Upgrade Guide"
subcategory: ""
description: |-
  Migration guide for upgrading the SigNoz provider from v0.0.14 to v0.0.15.
---

# SigNoz Provider v0.0.14 to v0.0.15 Upgrade Guide

Version v0.0.15 replaces the `signoz_dashboard` resource and data source with a new
